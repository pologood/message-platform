package com.message.shiro.freemarker;
 ...
 * (not necessarily during the current session) or from 'RememberMe' servicesImpl.
 *
 * <p><b>Note:</b> This is <em>less</em> restrictive than the <code>AuthenticatedTag</code> since it only assumes
 * the user is who they say they are, either via a current session login <em>or</em> via Remember Me servicesImpl, which
